...
Original file is located at
    https://colab.research.google.com/drive/1S1Q45ZKk6OEvra3TaYJmDsThECZgGRIN
"""
...
"""*We can see here the size of the dimentions are not the same *
...
# Finding out the mean dimentions of the images
print("Dimension 1 mean :" , np.mean(dim1),"Dimension 2 mean: ", np.mean(dim2))

# here, we can see that (50,50) is the average shape for all the images.
...
images = images/255 # Pixel value of each image between 0 to 255
